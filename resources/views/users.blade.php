...
@section('content')
    ...
    <div class="mt-8 rounded bg-white shadow overflow-hidden">
        <div class="p-4">
            <div class="flex">
                <div class="w-1/3 px-3 pt-6 pb-3 text-2xl text-green-600 font-semibold">User Name</div>
                <div class="w-1/3 px-3 pt-6 pb-3 text-2xl text-green-600 font-semibold">Club Name</div>
            </div>

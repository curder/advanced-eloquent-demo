    ...
    <ul class="flex text-gray-600 font-semibold" role="navigation">
        ...
        @if ($paginator->onFirstPage())
            <li class="mr-1" aria-disabled="true" aria-label="@lang('pagination.previous')">
                <span class="block px-3 py-2 border border-transparent bg-gray-300 rounded text-gray-500"
                      aria-hidden="true">Prev</span>
            </li>
        @else
            <li class="mr-1">
                <a class="block px-3 py-2 border border-gray-400 rounded hover:bg-white"
